...
const orders: Order[] = [
  ...
  // … คุณสามารถเพิ่ม orders ได้อีกไม่จำกัด
];
  ...
  return (
    <div className="mt-6 sm:mt-8">
      ...
      <div className="flex gap-6 sm:gap-12 md:gap-16 pl-4 sm:pl-6 md:pl-8 font-medium overflow-x-auto pb-2">
        <button className="cursor-pointer text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold shrink-0">
          ORDER
        </button>
        <button className="cursor-pointer text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#A3A3A3] shrink-0">
          HISTORY
        </button>
        <button className="cursor-pointer text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#A3A3A3] shrink-0">
          TOTAL
